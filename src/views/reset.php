...
<head>
  ...
  ================================================== -->
  <meta charset="utf-8">
  <title>NovaMart | Reset password</title>

  <!-- Mobile Specific Metas
  ================================================== -->
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <meta name="description" content="Reset your NovaMart password securely.">
            ...
            <?php if($success): ?>
                <div class="col-md-6 col-md-offset-3">
                    <div class="block text-center">
                        <form class="text-left clearfix" method="post" action="<?= htmlspecialchars($_SERVER['REQUEST_URI'] ?? site_url('reset'), ENT_QUOTES, 'UTF-8') ?>" >
